...
struct Util {
    ...
    static func methodsChannel(forPlayer playerId: String) -> String {
        return String(format: "com.anket.anket_audio.methods.%@", playerId)
    }

    static func eventsChannel(forPlayer playerId: String) -> String {
        return String(format: "com.anket.anket_audio.events.%@", playerId)
    }

    static func dataChannel(forPlayer playerId: String) -> String {
        return String(format: "com.anket.anket_audio.data.%@", playerId)
    }
}
