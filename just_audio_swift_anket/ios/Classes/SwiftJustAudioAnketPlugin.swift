...
public class SwiftJustAudioAnketPlugin: NSObject, FlutterPlugin {
    ...
    init(registrar: FlutterPluginRegistrar) {
        ...
        errorsChannel = BetterEventChannel(name: "com.anket.anket_audio.errors", messenger: self.registrar.messenger())
    }
...
// MARK: - SwiftJustAudioAnketPlugin commands handles

@available(iOS 13.0, *)
extension SwiftJustAudioAnketPlugin {
